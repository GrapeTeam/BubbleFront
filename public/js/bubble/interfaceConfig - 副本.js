(function () {
    // var host = "http://123.57.214.226";
    bubbleFrame.setHost({
        "18_226": "http://123.57.214.226:801",
        "16_226": "http://123.57.214.226:802",
        "19_226": "http://123.57.214.226:801",
        "21_226": "http://123.57.214.226:801",
        "13_226": "http://123.57.214.226:801",
        "17_226": "http://123.57.214.226:803",
        "18_60": "http://60.173.0.46:801",
        "19_60": "http://60.173.0.46:801",
        "13_60": "http://60.173.0.46:801",
        "15_60": "http://60.173.1.185:7000",
        "17_60": "http://60.173.0.45:803",
        "46_60": "http://60.173.0.46:803",      //大数据统计
    });
    ...
    bubbleFrame.setIns({
        ...
        "18_60": {
            ...
            message: ["18", "116"],
            adv: ["18", "114"],
            maintenanceUnit: ["18", "121"],
            operatingUnit: ["18", "122"],
            vote: ["18", "117"],
            link: ["18", "120"],
            task: ["18", "122"],
            api: ["18", "122"],
        ...
        "19_226": {
            ...
            adv: ["19", "118"],
            api: ["19", "127"],
            maintenanceUnit: ["19", "125"],
            operatingUnit: ["19", "126"],
            vote: ["19", "121"],
            link: ["19", "124"],
            task: ["19", "127"],
            template: ["19", "119"],
        ...
        "21_226": {
            ...
            message: ["21", "146"],
            adv: ["21", "144"],
            maintenanceUnit: ["21", "151"],
            operatingUnit: ["21", "152"],
            vote: ["21", "147"],
            link: ["21", "150"],
            task: ["21", "153"],
            api: ["21", "153"],
        ...
        "15_60": {
            app: ["GrapeFW", "GrapeFW"],
            act: ["15", "vote"],
            site: ["15", "GrapeWebInfo"],
            user: ["15", "GrapeUser"],
            content: ["15", "GrapeContent"],
            file: ["15", "GrapeFile"],
            message: ["15", "GrapeMessage"],
            adv: ["15", "GrapeAdvert"],
            maintenanceUnit: ["15", "GrapeMComp"],
            operatingUnit: ["15", "GrapeOComp"],
            vote: ["15", "GrapeVote"],
            link: ["15", "GrapeLink"],
            task: ["15", "GrapeTask"],
            api: ["15", "GrapeTask"],
            template: ["15", "GrapeTemplate"],
            search: ["15", "110"],
            wechat: ["15", "GrapeWechat"],
            email: ["15", "GrapeEmail"],
            report: ["15", "GrapeReport"],
            suggest: ["15", "108"],
            menu: ["15", "GrapeMenu"],
            statistics: ["15", "GrapeStatistics"]
        },
        "17_60": {
            webShow: ["17", "webshow"],
            crawler: ["17", "crawler"],
            wechat: ["17", "GrapeWechatArticle"]
        },
        "17_226": {
            webShow: ["17", "webshow"],
            crawler: ["17", "crawler"],
    ...
    bubbleFrame.registerInterface({
        ...
        service: {
            ...
            delete: ["app", "serviceService", "delete"],
        ...
        column: {
            ...
            batchDelete: ["content", "ContentGroup", "GroupBatchDelete"],
        ...
        content: {
            ...
            batchDelete: ["content", "Content", "BatchDelete"],
            batchDelete: ["content", "Content", "BatchDelete"],
            search: ["content", "Content", "SearchArticleBack", [typeList.Int, typeList.Int, typeList.String]],
            searchPush: ["content", "Content", "searchPushArticle", [typeList.Int, typeList.Int, typeList.String]],
            transmit: ["content", "ContentGroup", "UploadMpNew", [typeList.String, typeList.String, typeList.String]],
            pushTo: ["content", "Content", "pushToColumn", [typeList.String, typeList.String]],
            push: ["content", "Content", "pushArticle", [typeList.String, typeList.String]],
            pushToColumn: ["content", "Content", "pushArticles", [typeList.String, typeList.String]],
            show: ["content", "Content", "ShowArticle", [typeList.Int, typeList.Int, typeList.String]],
            review: ["content", "Content", "review", [typeList.String, typeList.String]],
        ...
        file: {
            ...
            download: "{host}/File/Download?_id=",
        },
        //留言评论
        message: {
        ...
        //第三方平台
        wechat: {
            page: ["wechat", "Wechat", "PageRoute"],
            update: ["wechat", "Wechat", "UpdateRoute"],
            delete: ["wechat", "Wechat", "DeleteRoute"],
            add: ["wechat", "Wechat", "AddRoute"],
            batchDelete: ["wechat", "Wechat", "DeleteBatchRoute"],
        },
        //第三方平台用户
        wechatUser: {
            page: ["wechat", "Wechat", "PagePUser"],
            pageBy: ["wechat", "Wechat", "PageByPUser"],
            update: ["wechat", "Wechat", "UpdatePUser"],
            delete: ["wechat", "Wechat", "DeletePUser"],
            add: ["wechat", "Wechat", "AddPUser"],
            savetowechat: ["wechat", "Article", "getNews", [typeList.String, typeList.String, typeList.String]],
            pushtowechat: ["wechat", "Article", "pushArcToWechat", [typeList.String, typeList.String, typeList.String]],
            batchDelete: ["wechat", "Wechat", "DeleteBatchPUser"],
        },
        //模板
        email: {
        ...
        menu: {
            ...
            set: ["menu", "Menu", "SetRole", [typeList.String, typeList.String]],
        },
        upload: {
            file: "http://123.57.214.226:8080/FileServer/UploadFile?appid={appid}",
            visible: "http://123.57.214.226:8080",
        }
    });
})()