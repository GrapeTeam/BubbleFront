bubbleFrame.register('linkController', function ($scope, bubble,$timeout) {
    /**
     * 站群编辑层级部分
     */
    ...
    $scope.btn = [
        {
            name: "新建根栏目",
            onClick: function (v) {
                bubble.customModal("linkCreate.html", "linkCreateModalController", "lg", { fatherid: 0, sort: 1, type: "0", wbid: window.localStorage.siteid, contentType: "0", timediff: 86400000, isreview: "0", slevel: "0" }, function (rs) {
    ...
    $scope.itembtn = [
        {
            name: "编辑",
            onClick: function (v) {
                bubble.customModal("linkCreate.html", "linkEditModalController", "lg",  v, function (rs) {
        ...
        },
        {
            name: "新建子栏目",
            onClick: function (v) {
                bubble.customModal("linkCreate.html", "linkCreateModalController", "lg", { fatherid: v._id, sort: 1, type: v.type, wbid: window.localStorage.siteid, contentType: "0", timediff: 86400000, isreview: "0", slevel: "0" }, function (rs) {
